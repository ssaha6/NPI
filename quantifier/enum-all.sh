...
for i in powerN power2 sum sumMax removeDuplicates setFind setInsert sparseMatrixGen sparseMatrixMul recordArrayUnzip recordArraySplit inverse; do
  echo "Generating predicates for $i.bpl";
