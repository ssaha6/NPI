...
for i in powerN power2 sum sumMax removeDuplicates setFind setInsert sparseMatrixGen sparseMatrixMul recordArraySplit recordArrayUnzip inverse; do
  echo "Verifying $i.bpl.bpl"
